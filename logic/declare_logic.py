...
def declare_logic():
    ...
    # Ensure the walker's stated price is within the range of $10 to $50 for each dog size.
    Rule.constraint(validate=Walker,
    ...
    # Assign a walker to a walk request based on matching availability, maximum dogs allowed, and dog size.
    Rule.sum(derive=WalkRequest.walker_id, as_sum_of=Walker.id,
