...
resourcename="dogwalkermanagementsystem"  # lower case, only
resourcegroup="dogwalkermanagementsystem_rg"
...
# git clone https://github.com/apilogicserver/dogwalkermanagementsystem.git
# cd dogwalkermanagementsystem
...
az group create --name dogwalkermanagementsystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group dogwalkermanagementsystem_rg --sku S1 --is-linux
az container create --resource-group dogwalkermanagementsystem_rg --name dogwalkermanagementsystem --image apilogicserver/dogwalkermanagementsystem:latest --dns-name-label dogwalkermanagementsystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//dogwalkermanagementsystem.westus.azurecontainer.io:5656'
